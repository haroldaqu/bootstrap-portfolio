    ...
    return ( 
        <footer className="border-0 d-flex flex-column justify-content-between position-relative mt-5" id="footer" >
            ...
            <div  className="border h-75" id="info">
                <div className="container p-4 d-flex  flex-column justify-content-end h-100"  id="info">
                    <div className="d-flex justify-content-center align-items-center h-100"  >
                        ...
                        <a className="text-light border border-white fs-5 m-2 rounded-1 text-decoration-none p-1" id="skills-ind" href="https://drive.google.com/file/d/1_EBnLeH5rQrWJ2vCKgLSIRTz6JAOxUYQ/view?usp=sharing" target="_blank">Resume</a> */}
                         <a className="bg-dark text-white border-0 fs-5 m-2 rounded-1 text-decoration-none p-1" href="https://github.com/haroldaqu" target="_blank">GitHub</a>
                                ...
                                <a className="bg-dark text-white border-0 fs-5 m-2 rounded-1 text-decoration-none p-1" href="https://drive.google.com/file/d/1_EBnLeH5rQrWJ2vCKgLSIRTz6JAOxUYQ/view?usp=sharing" target="_blank">Resume</a>
                    </div>
